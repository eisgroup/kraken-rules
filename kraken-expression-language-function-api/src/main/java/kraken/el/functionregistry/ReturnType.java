...
/**
 * Specifies return type of Expression Function.
 * <p/>
 * If method is annotated with {@link ReturnType} then function return type will be resolved using annotation.
 * <p/>
 * Annotation should be used in exceptional cases when default return type resolution by using Class name is not possible.
 ...
 *         Generic type is useful when parameter type is not known (generic), but related with the output the function,
 *         for example: <p>
