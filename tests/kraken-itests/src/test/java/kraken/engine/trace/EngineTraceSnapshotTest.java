...
public class EngineTraceSnapshotTest extends EngineBaseTest {
    ...
    public void shouldMatchTracerOutputSnapshot() {
        Clock mockedClock = Clock.fixed(Instant.parse("2023-01-01T00:00:00.00Z"), ZoneId.of("UTC"));
        ...
        try (MockedStatic<Clock> clock = Mockito.mockStatic(Clock.class)) {
            ...
            engine.evaluate(policy(), "TracerSnapshotTest", new EvaluationConfig());
