...
import { RuleOverride } from '../engine/results/RuleOverride'
...
export namespace RuleEvaluationResults {
    ...
    export type ApplicableRuleEvaluationResult = ValidationRuleEvaluationResult | RegularRuleEvaluationResult
