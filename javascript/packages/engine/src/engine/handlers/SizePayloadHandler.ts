...
import { SizePayloadResult, payloadResultCreator } from "../results/PayloadResult";
...
export class SizePayloadHandler implements RulePayloadHandler {
    ...
    executePayload(
        payload: SizePayload, rule: Rule, dataContext: DataContext, session: ExecutionSession
    ): SizePayloadResult {
