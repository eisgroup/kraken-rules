...
describe("Array Functions Test", () => {
    ...
    describe("Min function", () => {
        ...
        it("should throw on array with non numbers", () => {
            expect(() => mathFunctions.Min(["1", "a"])).toThrow();
        });
    });
        ...
        describe("default steps", () => {
            describe("default steps", () => {
                it("should generate sequence", () => {
                    ...
                    expect(NumberSequence(10002.00001, 10002.000051, 0.000001))
                        .toMatchSnapshot("10002.00001, 10002.000051, 0.000001");
                    expect(NumberSequence(1.00001, 1.00002, 1.000001))
                        .toMatchSnapshot("1.00001, 1.00002, 1.000001");
                    expect(NumberSequence(1000.0001, 1000.0002, 0.00001))
                        .toMatchSnapshot("1000.0001, 1000.0002, 0.00001 - 5 digits");
                    expect(NumberSequence(1000000.00001, 1000000.00002, 0.000001))
                        .toMatchSnapshot("1000000.00001, 1000000.00002, 0.000001 - 6 digits");
                });
                it("should throw on null parameters", () => {
                    expect(() => NumberSequence(undefined!, 3)).toThrowError(NumberSequence.name);
                    expect(() => NumberSequence(1, undefined!)).toThrowError(NumberSequence.name);
                });
            });
        });
