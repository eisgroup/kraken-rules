...
import { EvaluationConfig } from '../../src/engine/executer/SyncEngine'
...
export const sanityMocks = {
    ...
    valueListValid: (): TestProduct.kraken.testproduct.domain.Policy => ({
        id: '12',
        cd: 'Policy',
        policyCurrency: 'USD',
        policyValue: {
    ...
    valueListInvalid: (): TestProduct.kraken.testproduct.domain.Policy => ({
        id: '12',
        cd: 'Policy',
        policyCurrency: 'LTL',
        policyValue: {
    ...
    evalConf: (dimensions?: Record<string, unknown>, other?: Record<string, unknown>): EvaluationConfig => ({
        currencyCd: 'USD',
