    ...
    it("should evaluate rules with forEach on anubisCoverages", () => {
        ...
        policy.riskItems = [
            ...
            },
            {
                ...
                id: "888",
                anubisCoverages: [
                    { id: "003", cd: "AnubisCoverage", limitAmount: 10 }
                ]
            }
        ];
        ...
        it("should evaluate rules with forEach on anubisCoverages and fail", () => {
            ...
            expect(results).k_toMatchResultsStats({ total: 0, critical: 2 });
            expect(results).k_toHaveExpressionsFailures(0);
        }),
            ...
            policy.riskItems = [
                {
                    ...
                    anubisCoverages: [
                        {
                            id: "01", cd: "AnubisCoverage", code: "code1", limitAmount: 10,
                            cult: { id: "11", name: "CULT" }
                        },
                        {
                            id: "02", cd: "AnubisCoverage", code: "code2", limitAmount: 20,
                ...
                },
                {
                    ...
                    anubisCoverages: [
                        {
                            id: "03", cd: "AnubisCoverage", code: "code3", limitAmount: 30,
        ...
        it("should evaluate rules with forSome and forEvery on anubisCoverages and fail", () => {
            ...
            policy.riskItems = [
                {
                    ...
                    anubisCoverages: [
                        {
                            id: "01", cd: "AnubisCoverage", code: "code1", limitAmount: 20,
                            cult: { id: "11", name: "CULT" }
                        },
                        {
                            id: "02", cd: "AnubisCoverage", code: "code2", limitAmount: 20,
                ...
                },
                {
                    ...
                    anubisCoverages: [
                        {
                            id: "03", cd: "AnubisCoverage", code: "code3", limitAmount: 20,
                            cult: { id: "13", name: "CULT" }
                        }
                    ]
                }
            ...
            expect(results).k_toMatchResultsStats({ total: 0, critical: 1 });
            expect(results).k_toHaveExpressionsFailures(0);
        });
});
