...
describe("Cross context references sanity tests", () => {
    ...
    it("should find reference from 2nd level to root (condition false)", () => {
        ...
        const isRuleApplicable = ConditionEvaluationResult.isApplicable(conditionEvaluationResult);
    ...
    it(
        "should reference from 3rd to 2nd level different branch with a restriction - ExtendedModel",
        () => {
            expectEvaluationToBe({
