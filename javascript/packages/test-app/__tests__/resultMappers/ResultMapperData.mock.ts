...
export const mockValidationMetadataVisibleApplicable = () => (
    { isVisible: true, isApplicable: true, errMessage: "The field is mandatory" }
);

export const mockValidationMetadataWithoutMessage = () => (
    { isVisible: true, isApplicable: false, errMessage: "" }
);
