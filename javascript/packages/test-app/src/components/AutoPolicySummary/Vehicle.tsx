...
class Component extends React.Component<InnerInputsComponentProps<domain.Vehicle>> {
    ...
    onCOLLCoverageChange = (collCoverage: domain.COLLCoverage) => {
        this.props.onChange(
            Object.assign({}, this.props.value, {
                collCoverages: this.props.value.collCoverages.map(
                    coverage => Object.assign({}, coverage, collCoverage)
                )
            })
        );
    }
    ...
    onFullCoverageChange = (fullCoverage: domain.FullCoverage) => {
        this.props.onChange(
            Object.assign({}, this.props.value, {
                fullCoverages: this.props.value.fullCoverages.map(
                    coverage => Object.assign({}, coverage, fullCoverage)
                )
            })
        );
    }
