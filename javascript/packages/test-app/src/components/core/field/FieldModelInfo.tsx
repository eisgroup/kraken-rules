    ...
    render(): JSX.Element {
        return (
            <div>
                ...
                <br />
                <Tag color={typeColor(this.props)} style={tagStyle} >{this.props.fieldInfo.fieldType}</Tag>
                <Tag color={typeColor(this.props)} style={tagStyle} >{this.props.fieldInfo.cardinality}</Tag>
            </div>
        );
    }
}
