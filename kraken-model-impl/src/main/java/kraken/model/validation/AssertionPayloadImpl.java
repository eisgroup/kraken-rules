...
public class AssertionPayloadImpl extends ValidationPayloadImpl implements AssertionPayload {
    ...
    @Override
    public void setAssertionExpression(Expression assertionExpression) {
